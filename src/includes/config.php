...
define('BD_NAME', 'moviect');
define('BD_USER', 'adminDBMoviect');
define('BD_PASS', 'aMVEB7bAczM2GUB7');
define('RAIZ_APP', dirname(__DIR__));
define('RUTA_APP', '/');
define('RUTA_IMGS', RUTA_APP.'img/');
define('RUTA_CSS', RUTA_APP.'css/');
define('RUTA_JS', RUTA_APP.'js/');
define('RUTA_HTML', RUTA_APP.'html/');
define('RUTA_INCLUDES', RUTA_APP.'includes/');
define('RUTA_COMUN', RUTA_INCLUDES.'comun/');
define('INSTALADA', true );
define('DIR_FOTOS_USU', 'data/users/');
define('DIR_FOTOS_NOT', 'data/news/');
define('DIR_FOTOS_PEL', 'data/films/');
define('DIR_FOTO_SIN_PERFIL', 'img/');
